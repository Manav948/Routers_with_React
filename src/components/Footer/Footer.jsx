            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase hover:underline">Follow us</h2>
                            <ul className="text-gray-500 font-medium">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase hover:underline">Legal</h2>
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <Link to="#" className="hover:underline hover:text-orange-700">
                                        Privacy Policy
